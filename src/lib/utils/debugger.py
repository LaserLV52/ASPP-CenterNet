...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 4 or dataset == 'BDD':
  ...
  def show_all_imgs(self, pause=False, time=0,):
    if not self.ipynb:
      for i, v in self.imgs.items():
        ...
        cv2.imwrite('J:/Python program/CenterNet_2/data/BDD_demo_bbox/'+i+'.jpg', v, [int(cv2.IMWRITE_JPEG_QUALITY),100])
...
BDD_class_name = [ 'vehicle', 'person', 'two-wheelers']
